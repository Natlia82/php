...
$Upd = $result->fetch(PDO::FETCH_NUM);
if ($Upd[4] == 1) {
  $chec = "checked='checke'";
} else {
  $chec = "";
...
<!DOCTYPE html>
 ...
 <div class="container">
   <h5 class="left-align"><span class="teal-text text-lighten-2">ВОПРОС ОТ:<?php echo " ".$Upd[3]; ?></span></h5>
  <form class="col s10" method="post">
   <div class="input-field col s10">
     <div class="left teal-text text-lighten-2">Автор:</div>
     <textarea id="textarea1" class="materialize-textarea teal-text text-lighten-2" name="autor"><?php echo $Upd[6]; ?></textarea>
   </div>
      ...
      <div class="row">
           ...
           <div class="row">
             ...
             <div class="input-field col s10">
               ...
               <textarea id="textarea1" class="materialize-textarea teal-text text-lighten-2" name="textarea"><?php echo $Upd[1]; ?></textarea>
             </div>
             <div class="input-field col s10">
               <div class="left teal-text text-lighten-2">Ответ:</div>
               <textarea id="textarea1" class="materialize-textarea teal-text text-lighten-2" name="textarea2"><?php echo $Upd[2]; ?></textarea>
             </div>
           </div>
           <p>
            <label>
